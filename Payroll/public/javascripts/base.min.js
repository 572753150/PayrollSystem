...
+function (a) {
    ...
    function b(b) {
        return this.each(function () {
            var d = a(this), e = d.data("bs.pickdate"), f = a.extend({}, c.DEFAULTS, d.data(), "object" == typeof b && b);
    ...
    function h(a, b, c, d) {
        if (c) {
            ...
            var e = c.getAttribute("data-x"), f = c.getAttribute("data-y"), h = c.getAttribute("data-scale"), i = c.getAttribute("data-translate"), j = Date.now() - Number(c.getAttribute("data-hold")), k = 350 - j;
