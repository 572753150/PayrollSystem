...
!function (a, b) {
    ...
    function j(a) {
        var b, c, d = {top: 0, left: 0}, e = a && a.ownerDocument;
    ...
    function n(a, b, c, d) {
        if (c) {
            ...
            var e = c.getAttribute("data-x"), f = c.getAttribute("data-y"), g = c.getAttribute("data-scale"), h = c.getAttribute("data-translate"), i = Date.now() - Number(c.getAttribute("data-hold")), j = 350 - i;
    ...
    function q(a) {
        ...
        if (null !== b) {
            ...
            if (o.registerEvent(a), "touchstart" === a.type && l.delay) {
                var c = !1, e = setTimeout(function () {
                    e = null, l.show(a, b)
                }, l.delay), f = function (d) {
    ...
    var a = a || {}, b = document.querySelectorAll.bind(document), c = Object.prototype.toString, d = "ontouchstart" in window, l = {
        duration: 750,
        delay: 200,
        show: function (a, b, c) {
            ...
            var i = "scale(" + b.clientWidth / 100 * 3 + ")", m = "translate(0,0)";
    ...
    return a.init = function (a) {
        ...
        a = i(a);
        var c = a.length;
        if (b = b || {}, b.wait = b.wait || 0, b.position = b.position || null, c)for (var d, e, f, g = {}, h = 0, k = {
            type: "mousedown",
            button: 1
        }, m = function (a, b) {
            return function () {
        ...
        a = i(a);
        for (var b = {type: "mouseup", button: 1}, c = 0, d = a.length; d > c; c++)l.hide(b, a[c])
